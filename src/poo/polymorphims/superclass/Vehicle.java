package src.poo.polymorphims.superclass;
...
public class Vehicle {
    ...
    public String technicalSheet(){
        return String.format("brand:%s, model:%s, year:%d. Este vehículo no tiene categoría asignada.", getBrand(), getModel(), getYear());
    }
